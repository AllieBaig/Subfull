    ...
    if (this.state.hasError) {
      return (
        <div className="fixed inset-0 bg-system-background z-[9999] flex flex-col items-center justify-center p-6 text-center">
          <div className="w-16 h-16 bg-system-red/10 rounded-2xl flex items-center justify-center mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-system-blue text-system-background px-6 py-3 rounded-full text-sm font-medium active:scale-95 transition-transform"
          >
